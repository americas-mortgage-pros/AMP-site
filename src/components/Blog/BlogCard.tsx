...
function BlogCard({ item }: BlogCardProps) {
  ...
  return (
    <div >
      ...
      >
        <Card.Section>
          <Image src={Placeholder} height={200} alt="Norway" />
        </Card.Section>

        <Flex direction="column" gap="10" justify="left" mt="md">
          ...
          <Card.Section>
            ...
            <Flex px="md" justify="space-between">
              ...
              >
                {" "}
                <IconClockHour4Filled size={18} color="#868e96"></IconClockHour4Filled>{" "}
                <Text c="dimmed" size="sm" ta="center">
                  10 Hours Ago
                </Text>
              </Flex>
              <Divider orientation="vertical" size="xs" />
              <Flex p="md" align="center" style={{ flexBasis: "50%" }} justify="center">
                <Text c="dimmed" size="sm" ta="center">
                  5 Min Read
                </Text>
              </Flex>
