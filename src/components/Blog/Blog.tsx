...
function ScrollAnimations() {
  ...
  useEffect(() => {
    let controls;
    let finalPosition = -width / 2 - 6; // 6 is the number of items you have
  ...
  return (
    <motion.div style={{ position: "absolute", overflow: "unset", left: "0px", gap: "10px", display: "flex",
